      ...
      <div className="page-body">
        <div className="container">
          <main className="arcantia-homepage">
            <div className="page-body">
              <div className="container">
                <div className="arcantia-vote-page">
                  <div className="panel info">
                    <section className="section-intro">
                      <h1 className="panel-title">Voting Portal</h1>
                      <p>
                        Your daily votes are the lifeblood of Arcantia Network! Every single vote you cast helps our
