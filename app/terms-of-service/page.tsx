              ...
              <div className="panel-inner page-content post no-image">
                <section className="post-full-content">
                  <div className="post-content">
                    <p>
                      By using our Services, whether as a guest, as a registered user, or otherwise, you agree that these Terms of Service will govern your relationship with <strong>Arcantia Network</strong>. These Terms of Service apply to all users of the <strong>Arcantia Network</strong>. If you do not completely agree to these Terms of Service then you must not use any of our Services.
                    </p>
                    <h4>1. Definitions</h4>
                    <ul>
                      <li>"Account" refers to the Minecraft account used to access the Services.<br /></li>
                      <li>"Services" refers to the Minecraft server provided by Arcantia Network.<br /></li>
                      <li>"User" or "You" refers to any individual who accesses or uses the Services.<br /></li>
                      <li>"Server" refers to the Minecraft server operated by Arcantia Network.<br /></li>
                      ...
                      <li>"Arcantia Network" refers to "Us", "We", or "Our" as the service provider.<br /></li>
                    </ul>
                    <h4>2. Ownership and License</h4>
                    <h5>2.1 Ownership</h5>
                    <p>
                      The Services are owned or licensed by <strong>Arcantia Network</strong> and are protected by Intellectual Property Rights and other proprietary rights laws. <strong>Arcantia Network</strong> reserves all rights, titles, and interest in and to the Services, including without limitation all Intellectual Property Rights and other proprietary rights, that are not explicitly granted to you in these Terms. Your permitted use of the Services is limited by the Intellectual Property Rights of <strong>Arcantia Network</strong>.
                    </p>
                    <h5>2.2 License</h5>
                    <p>
                      <strong>Arcantia Network</strong> grants you a limited, non-exclusive, non-transferable, revocable license to use the Services for your personal, non-commercial use, subject to these Terms. This license does not grant you any ownership rights in the Services.
                    </p>
                    <h5>2.3 Accounts</h5>
                    <ul>
                      <li>You may access the Arcantia Network through your Microsoft Account (“Account”) and you agree to be bound by these Terms.<br /></li>
                    ...
                    <h4>3. Terms</h4>
                    <p>
                      Unless modified or amended by <strong>Arcantia Network</strong>, this agreement and its provisions shall remain in effect. Termination of any license granted by <strong>Arcantia Network</strong> under this agreement does not affect any other provisions of this agreement.
                    </p>
                    ...
                    <p>
                      If you have been previously banned from using any <strong>Arcantia Network</strong> Services, you may not use our Services.
                    </p>
