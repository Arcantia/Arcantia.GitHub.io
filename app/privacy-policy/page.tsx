              ...
              <div className="panel-inner page-content post no-image">
                <section className="post-full-content">
                  <div className="post-content">
                    <p>
                      This privacy policy (“Policy”) describes the data practices of <strong>Arcantia Network</strong>, covering its services under its control, including this website and the server. By using our services, such as playing on our server, you are consenting to this Policy and the processing of your data in the manner provided in this Policy. If you do not agree with these terms, please do not use the Services. This Privacy Policy was last updated on 1st May 2026.
                    </p>
