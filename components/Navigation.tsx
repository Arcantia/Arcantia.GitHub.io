...
export function Navigation() {
  ...
  return (
    <>
      <header id="arcantia-header" className="arcantia-header">
        <section className="top">
          <div className="container flex items-center">
            ...
            <nav className="nav-redirects flex items-center ml-auto">
              ...
              <Link href="/store" className="nav-link btn is-purple">
        ...
        <div id="mobile-nav" className="mobile-nav active">
          ...
          <div className="nav-collapse">
            ...
            <div className="nav-content">
              ...
              <Link href="/store" className="nav-link btn is-purple" onClick={() => setMobileMenuOpen(false)}>
                <i className="mdi mdi-storefront text-[22px] mr-2.5"></i>
                Store
              </Link>
            </div>
      ...
      <button type="button" onClick={handleCopy} className="header-server-ip">
        <div className="text text-right">
          ...
          <span className="small">
            <span className="arcantia-js--playercount">{playerCount ?? 0}</span> players online
          </span>
        </div>
